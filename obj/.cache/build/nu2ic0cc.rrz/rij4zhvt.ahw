...
<html>
  ...
  <head>
    ...
    <title>OSIsoft Adapter for Modbus TCP overview </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="OSIsoft Adapter for Modbus TCP overview ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="index">
<h1 id="osisoft-adapter-for-modbus-tcp-overview" sourcefile="V1/index.md" sourcestartlinenumber="5" sourceendlinenumber="5">OSIsoft Adapter for Modbus TCP overview</h1>

<p sourcefile="V1/index.md" sourcestartlinenumber="7" sourceendlinenumber="7">The OSIsoft Adapter for Modbus TCP is a data-collection component that transfers time-series data from source devices to OMF endpoints in OSIsoft Cloud Services or PI Servers. Modbus TCP is a commonly available communication protocol used for connecting and transmitting information between industrial electronic devices. The adapter can connect to any device that uses the Modbus TCP communication protocol.</p>
<p sourcefile="V1/index.md" sourcestartlinenumber="9" sourceendlinenumber="9"><img src="images/OSIsoft_Adapter_for_Modbus_TCP_architecture_diagram.png" alt="OSIsoft Adapter for Modbus TCP architecture" sourcefile="V1/index.md" sourcestartlinenumber="9" sourceendlinenumber="9"></p>
<p sourcefile="V1/index.md" sourcestartlinenumber="11" sourceendlinenumber="11">The adapter is installed with a download kit obtained from the OSIsoft Customer Portal and works on devices running either Windows or Linux operating systems.</p>
<p sourcefile="V1/index.md" sourcestartlinenumber="13" sourceendlinenumber="13">All functions of the adapter are configured using the REST API. The configurations are stored in JSON files. For data ingress, you must define an adapter component in the system components configuration for each device to which the adapter will connect. You configure each adapter component with the connection information for the device and the data to collect. For data egress, you must specify destinations for the data, including security for the outgoing connection. Additional configurations are available to egress health and diagnostics data, add buffering configuration to protect against data loss, and record logging information for troubleshooting purposes.</p>
<p sourcefile="V1/index.md" sourcestartlinenumber="15" sourceendlinenumber="15">Once you have configured the adapter and it is sending data, administration functions are used to manage the adapter or individual ingress components of the adapter. Health and diagnostics functions monitor the status of connected devices, adapter system functions, the number of active data streams, the rate of data ingress, the rate of errors, and the rate of data egress.</p>
<p sourcefile="V1/index.md" sourcestartlinenumber="17" sourceendlinenumber="17">The EdgeCmd utility is an OSIsoft proprietary command line tool that is used to configure and administer an adapter on both Linux and Windows operating systems. It is installed separately from the adapter.</p>
<!--
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/osisoft/OSIsoft-Adapter-Modbus-Docs/blob/master/V1/index.md/#L1" class="contribution-link">Improve this Doc</a>
                  </li>
                </ul>
              </div>
