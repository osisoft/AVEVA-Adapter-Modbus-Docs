---
uid: PIAdapterForModbusTCPSystemComponentsConfiguration
---
...
| api/v1/configuration/system/components/_componentId_ | DELETE | Deletes a specific component from the system components configuration<br>**Note:** All the logs and configurations files for the deleted components are moved to the corresponding _logs/Removed_ or _Configuration/Removed_ folder.|
